package com.drinkhere.drinklycoupon.common.response;
...
public class ApplicationResponse<T> {
    ...
    public static <T> ApplicationResponse<T> created(T payload) {
        return ApplicationResponse.<T>builder()
                .result(ApplicationResult.builder()
    ...
    public static <T> ApplicationResponse<T> created(T payload, String message) {
        return ApplicationResponse.<T>builder()
                .result(ApplicationResult.builder()
                        .code(HttpStatus.CREATED.value())
                        .message(message)
